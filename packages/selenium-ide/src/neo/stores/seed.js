...
export default function seed(store, numberOfSuites = 0) {
  ...
  executeDatabase.createCommand(undefined, 'executeDatabase', '{"command": "createDB" ,"dbName": "stockDB" ,"tables" : [{"name":"m_contries", "uks":["sys_uk01"], "indexs":["name"]}, {"name":"t_stocks", "uks":["sys_uk01"], "indexs":["id", "name"]}]}', '')
  executeDatabase.createCommand(undefined, 'executeDatabase', '{"command": "insert" ,"dbName": "stockDB" ,"table" : "m_contries", "datas" :[{"id":"01", "name":"japan", "sys_uk01":"01"}, {"id":"02", "name":"usa", "sys_uk01":"02"}]}', '')
  executeDatabase.createCommand(undefined, 'executeDatabase', '{"command": "insert" ,"dbName": "stockDB" ,"table" : "t_stocks"  , "datas" :[{"id":"01", "name":"株１", "sys_uk01":"01"}, {"id":"02", "name":"株２", "sys_uk01":"02"}]}', '')
